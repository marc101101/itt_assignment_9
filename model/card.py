...
from PyQt5.QtWidgets import QFrame, QLineEdit, QPlainTextEdit, QLabel, QTextEdit
...
class Card(QFrame):
    ...
    def setup_assigned_to(self):
        ...
        self.assigned_to_edit.move(120, 100)
